...
\newCJKfontfamily\fancyfont{HakusyuKaisyoBold}
...
\usepackage{etoolbox}
%
\newcommand{\kana}[1]{\begin{tcolorbox}[enhanced,colframe=white, size=minimal,opacityback=0]\ipag\fontsize{14}{14}#1 \end{tcolorbox}}
%
%
...
%
%
\newcommand{\strokes}[1]{\centering\begin{tcolorbox}[colframe=white, colupper=black,left=0mm, square, finish={\draw [gray, thick, dotted, rounded corners=1mm] (-0.1,-2) rectangle (1.9,1.8);}]\hfuzz=99pt\fontsize{42}{42}#1 \end{tcolorbox}}
%
%
